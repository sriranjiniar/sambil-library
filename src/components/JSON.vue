...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="work in austenWorks.famousWorks" :key="title">
    ...
    <section class="lab-section">
      ...
      <!-- Activity 10: Iterate through the storeTypes array and display the store type and the number of stores that use that type. -->
        <ul>    
          <li v-for="(key, val)  in bookstores.storeTypes" >
             No. of {{ val }} stores:  {{ key }}
          </li>
        </ul>
      ...
      <!-- Activity 11: Iterate through the openingHours object and display the day of the week and the opening and closing times. -->
       <ul>
        <li v-for="(key, val) in bookstores.openingHours">
          During {{ val }}, open from {{ key.open }} to {{ key.close }}
        </li>
       </ul>
      ...
      <p>We operate in:</p>
      <ul>
        <li v-for="item in bookstores.countries">
          {{  item }}
        </li>
      </ul>
      <p>Our #1 seller:</p>
      <ul>
        <li v-for="item in bookstores.topSellers">
          {{  item }}
        </li>
      </ul>
    </section>
